...
class LetrasDetector(BaseDetector):
    ...
    def __init__(self):
        super().__init__()
        self.letras_config = {
            "Letra - A": [1, 1, 0, 0, 0, 0],"Letra - B": [0, 0, 1, 1, 1, 1],
            "Letra - C": [1, 1, 1, 1, 1, 1], "Letra - D": [0, 0, 0, 0, 0, 1],
            "Letra - E": [0, 0, 0, 0, 0, 0], "Letra - F": [1, 1, 1, 1, 1, 0],
            "Letra - G": [1, 0, 0, 1, 1, 1], "Letra - H": [1, 0, 0, 0, 1, 1],
            "Letra - I": [0, 0, 1, 0, 0, 0], "Letra - K": [1, 1, 0, 0, 1, 1],
            "Letra - L": [1, 1, 0, 0, 0, 1],"Letra - M": [1, 1, 1, 0, 0, 0],
            "Letra - N": [0, 1, 0, 0, 1, 1],"Letra - O": [1, 0, 1, 0, 0, 0],
            "Letra - P": [0, 1, 1, 1, 1, 1], "Letra - Q": [1, 0, 0, 0, 0, 1],
            "Letra - R": [0, 1, 0, 0, 1, 0], "Letra - S": [1, 1, 1, 1, 1, 1],
            "Letra - T": [1, 1, 1, 1, 0, 1], "Letra - U": [0, 0, 1, 0, 0, 1],
            "Letra - V": [0, 1, 0, 0, 1, 1], "Letra - W": [0, 1, 0, 1, 1, 1],
            "Letra - X": [1, 0, 1, 1, 1, 1], "Letra - Y": [1, 1, 1, 0, 0, 0],
            "Letra - Z": [1, 0, 0, 1, 1, 0],
        }
